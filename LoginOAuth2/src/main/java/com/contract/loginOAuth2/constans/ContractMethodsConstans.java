package com.contract.loginOAuth2.constans;

public class ContractMethodsConstans {
	// public static final String URL_CONTRACT = "https://contract-database.herokuapp.com";
