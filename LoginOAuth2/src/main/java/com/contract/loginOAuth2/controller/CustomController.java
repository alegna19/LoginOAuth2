...
import com.contract.entities.Response;
...
public class CustomController {
	...
	public Response findAll() throws DataBaseResultNotFoundException {
		try{
			RestTemplate restTemplate = new RestTemplate();
			Response customsList = restTemplate.getForObject(URL_CONTRACT + CUSTOM_FIND_ALL, Response.class);
			return customsList;
		}
		catch(Exception e){
	...
	@Secured(CAN_READ_USERS)
	public ResponseEntity<Response> insert(@RequestBody Custom custom) {
		try {
			RestTemplate restTemplate = new RestTemplate();
			String URL = URL_CONTRACT + CUSTOM_INSERT_CONTRACT;
